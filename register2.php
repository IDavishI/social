		...
		<main class="main-content page__main-content">
			...
			<form action="register/register.php" method="POST" class="register__form">
				<div class="register__input-wrapper">
					<input type="text" placeholder="Возраст" name="age" required class="register__input">
				</div>
				<div class="register__input-wrapper">
					<input type="date" placeholder="Год рождения" name="birth_year" required class="register__input">
				</div>
				<div class="register__input-wrapper">
					<select name="gender" class="register__input">
						<option value="male">Муж.</option>
						<option value="female">Жен.</option>
					</select>
				</div>
				<div class="register__input-wrapper">
					<input type="tel" placeholder="Телефон" name="phone" required class="register__input">
				</div>
