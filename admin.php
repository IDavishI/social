<?php 
  ...
  $user_id = -1;
  $role = '';
  if(isset($_COOKIE[$cookie_name]) && isset($_COOKIE[$cookie_role]) && $_COOKIE[$cookie_role] == 'admin'){
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="pages/users/data.php"><i class="fa fa-user"></i> <span>Users</span></a></li>
        <li>
          <a href="pages/events/data.php">
